...
export default function Home() {
  ...
  return (
    <main ref={containerRef} className="font-sans">
      <section className="hero-section relative isolate min-h-screen flex flex-col items-center justify-center bg-[#933600] text-white" style={{ backgroundColor: '#933600', color: '#ffffff' }}>
